...
and structure = {
  ...
  str_size : int; (* on pourra ajouter plus tard ici la taille totale de la structure *)
}

and field = {
  field_name: string;
  field_typ : typ;
  field_pos : int; (* on pourra ajouter plus tard ici la position du champ dans la structure *)
}
